...
use Praetorius\ViteAssetCollector\Event\ModifyDevServerEnabledEvent;
...
final class ViteServiceTest extends UnitTestCase
{
    ...
    {
        $expectation = new ModifyDevServerEnabledEvent('auto');
        $eventDispatcher = $this->createMock(EventDispatcherInterface::class);
        $eventDispatcher
            ->expects(self::once())
            ->method('dispatch')
            ->with($expectation)
            ->willReturnCallback(function (ModifyDevServerEnabledEvent $event) {
